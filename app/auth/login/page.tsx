    ...
    <main style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', minHeight: '100vh' }}>
      ...
      <div style={{ background: 'var(--bottle)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: '40px 48px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 2 }}>
          ...
          <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.55)', lineHeight: 1.7, maxWidth: 340 }}>
            Sign in to manage your UK settling-in pack, track orders and access your dashboard.
          </p>
        </div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '48px 64px', background: 'var(--offwhite)' }}>
        <div style={{ width: '100%', maxWidth: 400 }}>
          ...
          <p style={{ fontSize: 14, color: 'var(--muted)', marginBottom: 32 }}>Welcome back — let's pick up where you left off.</p>

          <button onClick={signInWithGoogle} style={{ width: '100%', padding: '13px 20px', fontSize: 14, fontWeight: 400, color: 'var(--ink)', background: '#fff', border: '0.5px solid rgba(26,26,26,0.15)', borderRadius: 10, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, boxShadow: '0 1px 4px rgba(0,0,0,0.06)', marginBottom: 12, fontFamily: 'DM Sans, sans-serif' }}>
          ...
          <div style={{ textAlign: 'center', fontSize: 13, color: 'var(--muted)' }}>
            ...
            <Link href="/auth/signup" style={{ color: 'var(--forest)', fontWeight: 500, textDecoration: 'none' }}>Sign up free</Link>
          </div>
        </div>
      </div>
    </main>
