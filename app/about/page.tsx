...
export const metadata = {
  ...
  description: 'We help international students settle into UK life before they even land.',
}
...
export default function About() {
  return (
    <div style={{ background: 'var(--cream)', minHeight: '100vh' }}>
      ...
      {/* HERO */}
      <div style={{ background: 'var(--bottle)', padding: '120px 8% 80px', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '80px 8%', background: 'var(--offwhite)' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center', maxWidth: 1100, margin: '0 auto' }}>
          <div>
            ...
            <p style={{ fontSize: 15, color: 'var(--muted)', lineHeight: 1.8, marginBottom: 16 }}>Every year, hundreds of thousands of international students arrive in the UK carrying too many bags and too much anxiety. They scramble to buy bedding, queue for SIM cards, and overpay for everything.</p>
            <p style={{ fontSize: 15, color: 'var(--muted)', lineHeight: 1.8, marginBottom: 16 }}>We partner with trusted UK suppliers to deliver everything students need — before they board the plane. One cart, one checkout, everything sorted.</p>
            <p style={{ fontSize: 15, color: 'var(--muted)', lineHeight: 1.8 }}>We also work with education agents worldwide, giving them the tools to support their students end-to-end and earn fairly for it.</p>
          </div>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24 }}>
            {[
              ...
              { icon: '🌱', title: 'Grounded', body: 'Bottle green for a reason. We are calm, reliable, and rooted — not flashy. Students need steady, not showy.' },
              { icon: '💷', title: 'Fair value', body: 'Best rates on remittance, insurance and SIMs. Students should not be exploited just because they are new to a country.' },
      ...
      <div style={{ padding: '80px 8%', background: 'var(--bottle)' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
            {[
              { icon: '🎓', title: 'International Students', desc: 'You are about to start the biggest adventure of your life. We make sure you arrive in the UK with your room ready, your phone connected, and your first day sorted.', cta: 'Start building your pack', href: '/services' },
              { icon: '🏢', title: 'Education Agents', desc: 'You work hard to place students at great universities. We give you the tools to support them beyond enrolment — and earn a commission on every service they use.', cta: 'Join as an agent', href: '/auth/signup' },
            ].map(card => (
              <div key={card.title} style={{ background: 'rgba(255,255,255,0.06)', border: '0.5px solid rgba(255,255,255,0.12)', borderRadius: 20, padding: '36px 32px' }}>
                ...
                <Link href={card.href} style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '11px 24px', background: 'var(--forest)', color: '#fff', borderRadius: 40, textDecoration: 'none', fontSize: 14, fontWeight: 500 }}>{card.cta} →</Link>
              </div>
            ))}
          </div>
        </div>
      ...
      <div style={{ padding: '80px 8%', background: 'var(--offwhite)' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', textAlign: 'center' }}>
          ...
          <Link href="/services" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '14px 32px', background: 'var(--forest)', color: '#fff', borderRadius: 40, textDecoration: 'none', fontSize: 15, fontWeight: 500 }}>Browse all services →</Link>
        </div>
      </div>
      ...
      <div style={{ padding: '80px 8%', background: 'var(--cream)', textAlign: 'center' }}>
        <div style={{ maxWidth: 560, margin: '0 auto' }}>
          <h2 style={{ fontFamily: 'Playfair Display, Georgia, serif', fontSize: 'clamp(26px,3vw,38px)', fontWeight: 500, color: 'var(--bottle)', marginBottom: 16 }}>Ready to land prepared?</h2>
          <p style={{ fontSize: 16, color: 'var(--muted)', lineHeight: 1.7, marginBottom: 36 }}>Join thousands of international students who sorted their UK life before they boarded the plane.</p>
          <div style={{ display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link href="/auth/signup" style={{ padding: '14px 32px', fontSize: 15, fontWeight: 500, color: '#fff', background: 'var(--forest)', borderRadius: 40, textDecoration: 'none' }}>Create free account →</Link>
            <Link href="/services" style={{ padding: '14px 32px', fontSize: 15, color: 'var(--bottle)', border: '0.5px solid rgba(26,58,42,0.3)', borderRadius: 40, textDecoration: 'none' }}>View services</Link>
          </div>
        </div>
      </div>
